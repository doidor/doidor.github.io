...
!(function () {
  ...
  var c = (e.navigator || {}).userAgent,
    ...
    z = { fas: 'solid', far: 'regular', fal: 'light', fad: 'duotone', fab: 'brands', fa: 'solid' },
  ...
  p &&
    ((X = (v.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(v.readyState)) ||
  ...
  (gt.prototype = {
    ...
    _handled: !1,
    then: function (t, e) {
      var n = { owner: this, then: new this.constructor(et), fulfilled: t, rejected: e };
      return (
        (!e && !t) || this._handled || ((this._handled = !0), this._state === tt && nt && ot(ht, this)),
  ...
  function jt(t) {
    var e = t.icons,
      ...
      g = [J.replacementClass, i ? ''.concat(J.familyPrefix, '-').concat(i) : '', h]
        .filter(function (t) {
    ...
    u && (v.attributes[G] = ''),
      s &&
        v.children.push({
          tag: 'title',
          attributes: { id: v.attributes['aria-labelledby'] || 'title-'.concat(kt()) },
          children: [s],
        });
    var b,
      y,
      ...
      U,
      W,
      q = K({}, v, { prefix: r, iconName: i, main: n, mask: a, transform: o, symbol: c, styles: l.styles }),
      X =
        a.found && n.found
          ? ((w = (b = q).children),
            (x = b.attributes),
            ...
            (j = {
              ...
              children: [Et(K({ tag: S.tag, attributes: K({}, S.attributes, M.path) }, E))],
            }),
            ...
            (T = {
              tag: 'mask',
              attributes: K({}, zt, { id: R, maskUnits: 'userSpaceOnUse', maskContentUnits: 'userSpaceOnUse' }),
              children: [z, L],
            }),
            (I = {
              tag: 'defs',
              children: [
                { tag: 'clipPath', attributes: { id: _ }, children: ((y = N), 'g' === y.tag ? y.children : [y]) },
                T,
              ],
            }),
            w.push(I, {
              tag: 'rect',
              attributes: K(
                { fill: 'currentColor', 'clip-path': 'url(#'.concat(_, ')'), mask: 'url(#'.concat(R, ')') },
                zt,
              ),
            }),
                  ...
                  children: [
                    {
                      ...
                      children: [
                        { tag: a.icon.tag, children: a.icon.children, attributes: K({}, a.icon.attributes, o.path) },
                      ],
                    },
                  ],
                });
          ...
          [
            {
              ...
              children: [
                {
                  tag: 'symbol',
                  attributes: K({}, U, { id: !0 === W ? ''.concat(F, '-').concat(J.familyPrefix, '-').concat(H) : W }),
                  children: D,
                },
              ],
            },
        ...
        : (function (t) {
            ...
            if (Nt(o) && n.found && !a.found) {
              var c = n.width / n.height / 2,
                s = 0.5;
              r.style = Pt(K({}, i, { 'transform-origin': ''.concat(c + o.x / 16, 'em ').concat(s + o.y / 16, 'em') }));
            }
  ...
  function Lt(t) {
    var e = t.content,
      ...
      c = t.watchable,
      s = void 0 !== c && c,
      l = K({}, o.attributes, i ? { title: i } : {}, { class: o.classes.join(' ') });
    s && (l[G] = '');
    var f,
      u,
      d,
  ...
  var Rt = function () {},
    _t = J.measurePerformance && f && f.mark && f.measure ? f : { mark: Rt, measure: Rt },
    Tt = 'FA "5.12.1"',
    It = function (t) {
  ...
  function Jt(t) {
    return t.reduce(function (t, e) {
      ...
      if (Kt[e]) t.prefix = e;
        ...
        var a = 'fa' === t.prefix ? Xt[n] || { prefix: null, iconName: null } : {};
  ...
  var ee = {
    replace: function (t) {
      ...
      if (e.parentNode && e.outerHTML)
        e.outerHTML =
          n +
          (J.keepOriginalSource && 'svg' !== e.tagName.toLowerCase() ? '\x3c!-- '.concat(e.outerHTML, ' --\x3e') : '');
  ...
  function ce(t) {
    if (l && J.observeMutations) {
      ...
      (oe = new l(function (t) {
        ...
        p && oe.observe(n, { childList: !0, attributes: !0, characterData: !0, subtree: !0 });
    }
  }
  function se(t) {
    var e,
    ...
    return (
      ...
      o.prefix && 1 < i.length
        ...
        : o.prefix && 1 === i.length && (o.iconName = Vt(o.prefix, Ht(t.innerText))),
      o
    );
  }
  var le = function (t) {
  ...
  function fe(t) {
    var e,
      ...
      h =
        ...
        J.autoA11y &&
          (o
            ? (i['aria-labelledby'] = ''.concat(J.replacementClass, '-title-').concat(kt()))
    ...
    ge = {
      ...
      children: [
        pe,
        {
          ...
          children: [
            { tag: 'animate', attributes: K({}, me, { attributeName: 'r', values: '28;14;28;28;14;28;' }) },
            { tag: 'animate', attributes: K({}, he, { values: '1;0;1;1;0;1;' }) },
          ],
        },
        {
          tag: 'path',
          ...
          children: [{ tag: 'animate', attributes: K({}, he, { values: '1;0;0;0;0;1;' }) }],
        },
        {
          tag: 'path',
          attributes: K({}, de, {
          ...
          children: [{ tag: 'animate', attributes: K({}, he, { values: '0;0;1;1;0;0;' }) }],
        },
      ],
    },
    ve = W.styles;
  function be(t) {
    ...
    return {
      ...
      icon: Array.isArray(a)
        ? {
            tag: 'g',
            attributes: { class: ''.concat(J.familyPrefix, '-').concat(Y.GROUP) },
            children: [
              {
                tag: 'path',
                attributes: {
              ...
              {
                tag: 'path',
                attributes: { class: ''.concat(J.familyPrefix, '-').concat(Y.PRIMARY), fill: 'currentColor', d: a[1] },
              },
            ],
          }
        ...
        if (!l || (e && e.getAttribute(C) === c && e.getAttribute(O) === f)) a();
          ...
          (d.attributes[w] = p),
            ye(l, c)
              .then(function (t) {
                var e = jt(
                    K({}, u, { icons: { main: t, mask: Gt() }, prefix: c, iconName: f, extra: d, watchable: !0 }),
                  ),
  ...
  var Le,
        ...
        !1 === J.autoReplaceSvg && (J.autoReplaceSvg = !0),
          ...
          B(function () {
            Fe({ autoReplaceSvgRoot: e }),
              ce({ treeCallback: ke, nodeCallback: Ae, pseudoElementsCallback: Pe, observeMutationsRoot: n });
          });
      },
    },
    Ie =
        ...
        if (t) {
          ...
          return Ee(K({ type: 'icon' }, t), function () {
            return (
              ...
              J.autoA11y &&
                (l
                  ? (m['aria-labelledby'] = ''.concat(J.replacementClass, '-title-').concat(kt()))
                  : ((m['aria-hidden'] = 'true'), (m.focusable = 'false'))),
              jt({
                icons: { main: be(b), mask: c ? be(c.icon) : { found: !1, width: null, height: null, icon: {} } },
                prefix: g,
                iconName: v,
                transform: K({}, yt, a),
                symbol: i,
      ...
      function (t) {
        var e = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {},
          n = (t || {}).icon ? t : je(t || {}),
          a = e.mask;
        return a && (a = (a || {}).icon ? a : je(a || {})), Le(n, K({}, e, { mask: a }));
      }),
    Ye = {
      noAuto: function () {
        ...
        return Ee({ type: 'text', content: t }, function () {
          return (
            ...
            Lt({
              ...
              transform: K({}, yt, a),
              title: i,
              extra: { attributes: l, styles: u, classes: [''.concat(J.familyPrefix, '-layers-text')].concat(m(c)) },
            })
          );
        });
      },
          ...
          return (
            ...
            (function (t) {
              var e = t.content,
                n = t.title,
                a = t.extra,
                r = K({}, a.attributes, n ? { title: n } : {}, { class: a.classes.join(' ') }),
                i = Pt(a.styles);
              ...
              content: t.toString(),
              title: a,
              extra: { attributes: c, styles: l, classes: [''.concat(J.familyPrefix, '-layers-counter')].concat(m(i)) },
            })
          );
        });
      },
        ...
        return Ee({ type: 'layer' }, function () {
          ...
          return (
            ...
            [
              {
                tag: 'span',
                attributes: { class: [''.concat(J.familyPrefix, '-layers')].concat(m(n)).join(' ') },
                children: e,
              },
            ]
          );
    ...
    Fe = function () {
      var t = (0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {}).autoReplaceSvgRoot,
        e = void 0 === t ? v : t;
      (0 < Object.keys(W.styles).length || J.autoFetchSvg) && p && J.autoReplaceSvg && Ye.dom.i2svg({ node: e });
    };
  !(function (t) {
    try {
      t();
