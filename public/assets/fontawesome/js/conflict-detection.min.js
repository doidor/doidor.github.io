                ...
                (s = g(
                  (s = g(
                    (s = g(
                      (s = g(
                        (s = h(
                          (s = h(
                            ...
                            (f = h(
                              f,
                              (l = h(l, (a = h(a, s, f, l, e[n + 13], 4, 681279174)), s, f, e[n], 11, -358537222)),
                              a,
                              s,
                              e[n + 3],
                              16,
                          ...
                          (f = h(
                            f,
                            (l = h(l, (a = h(a, s, f, l, e[n + 9], 4, -640364487)), s, f, e[n + 12], 11, -421815835)),
                            a,
                            s,
                            e[n + 15],
                            16,
                        ...
                        (f = g(
                          f,
                          (l = g(l, (a = g(a, s, f, l, e[n], 6, -198630844)), s, f, e[n + 7], 10, 1126891415)),
                          a,
                          s,
                          e[n + 14],
                          15,
                      ...
                      (f = g(
                        f,
                        (l = g(l, (a = g(a, s, f, l, e[n + 12], 6, 1700485571)), s, f, e[n + 3], 10, -1894986606)),
                        a,
                        s,
                        e[n + 10],
                        15,
                    ...
                    (f = g(
                      f,
                      (l = g(l, (a = g(a, s, f, l, e[n + 8], 6, 1873313359)), s, f, e[n + 15], 10, -30611744)),
                      a,
                      s,
                      e[n + 6],
                      15,
                  ...
                  (f = g(
                    f,
                    (l = g(l, (a = g(a, s, f, l, e[n + 4], 6, -145523070)), s, f, e[n + 11], 10, -1120210379)),
                    a,
                    s,
                    e[n + 2],
                    15,
            ...
            function i(e, t) {
              return (function (e, t) {
                var n,
                  ...
                  i = [],
                  c = [];
                for (i[15] = c[15] = void 0, 16 < r.length && (r = s(r, 8 * e.length)), n = 0; n < 16; n += 1)
          ...
          var e = Array.from(u.getElementsByTagName('link')).filter(function (e) {
            ...
            t = Array.from(u.getElementsByTagName('style')).filter(function (e) {
              return !(
                e.hasAttribute(x) ||
                (l.FontAwesomeConfig &&
                  e.innerText.match(new RegExp('svg:not\\(:root\\)\\.'.concat(l.FontAwesomeConfig.replacementClass))))
              );
            });
          function n(e, t) {
      ...
      console.group('Font Awesome Detector'),
        0 === i
          ...
          : (console.info('Testing '.concat(i, ' possible conflicts.')),
            ...
            console.info(
              '\t%c'.concat(A, "%c: milliseconds to wait for each test before deciding whether it's a conflict."),
              'font-weight: bold;',
              'font-size: normal;',
            ),
            console.info(
              '\t%c'.concat(T, '%c: milliseconds to wait for the browser to accumulate test results before giving up.'),
              'font-weight: bold;',
              'font-size: normal;',
            ),
            E({
      ...
      N = a(
        {},
        {
          report: function (e) {
            ...
            if (0 < i) {
              ...
              for (var a in t.conflict) {
                ...
                c[a] = {
                  ...
                  'innerText excerpt':
                    s.innerText && '' !== s.innerText ? s.innerText.slice(0, 200) + '...' : '(empty)',
                };
              }
              console.table(c);
            }
            ...
            if (0 < f) {
              console.info(
                '%cNo conflict'.concat(1 < f ? 's' : '', ' found with ').concat(1 == f ? 'this' : 'these', ':'),
              ...
              for (var u in t.noConflict) {
                ...
                l[u] = {
                  ...
                  'innerText excerpt':
                    d.innerText && '' !== d.innerText ? d.innerText.slice(0, 200) + '...' : '(empty)',
                };
              }
              console.table(l);
            }
            ...
            if (0 < m) {
              console.info(
                '%cLeftovers--we timed out before collecting test results for '.concat(1 == m ? 'this' : 'these', ':'),
              ...
              for (var g in o) {
                ...
                h[g] = {
                  ...
                  'innerText excerpt':
                    p.innerText && '' !== p.innerText ? p.innerText.slice(0, 200) + '...' : '(empty)',
                };
              }
              console.table(h);
            }
